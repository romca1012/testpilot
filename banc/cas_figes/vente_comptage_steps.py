"""Cas FIGÉ du banc de mesure (lot 04) — vente_comptage. Écrit à la main, sans LLM : il tient lieu de version de
...
@when('je crée une commande de vente pour un client de test')
def step_creer(context):
    _commande_vente(context)
