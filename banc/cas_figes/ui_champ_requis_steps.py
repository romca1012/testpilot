"""Cas FIGÉ du banc de mesure (lot 04) — ui_champ_requis. Écrit à la main, sans LLM : il tient lieu de version de
...
# Aucun step propre : ce cas n'emploie que la bibliothèque (interface Odoo).
# ⚠️ Navigation par l'URL de l'ACTION et non `je navigue vers le menu Odoo` : ce step ouvre `/web#action=menu`, qui
# n'existe pas sur Odoo 17.0 Community (« L'action 'menu' n'existe pas ») — constat du banc, voir le rapport du lot 04.
