"""Cas FIGÉ du banc de mesure (lot 04) — achat_confirmation. Écrit à la main, sans LLM : il tient lieu de version de
...
@when("je désigne la commande d'achat comme enregistrement courant")
def step_courant(context):
    context.last_record_ids = [context.achat_id]
    context.last_record_model = "purchase.order"
