"""Cas FIGÉ du banc de mesure (lot 04) — portail_acces. Écrit à la main, sans LLM : il tient lieu de version de
...
@then("l'espace personnel du portail est affiché")
def step_portail(context):
    constater("/my" in context.page.url and "/web/login" not in context.page.url,
              f"L'espace personnel n'est pas affiché (URL : {context.page.url}).")
