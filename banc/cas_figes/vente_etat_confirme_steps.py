"""Cas FIGÉ du banc de mesure (lot 04) — vente_etat_confirme. Écrit à la main, sans LLM : il tient lieu de version de
...
@when('je désigne la commande de vente comme enregistrement courant')
def step_courant(context):
    context.last_record_ids = [context.commande_id]
    context.last_record_model = "sale.order"
