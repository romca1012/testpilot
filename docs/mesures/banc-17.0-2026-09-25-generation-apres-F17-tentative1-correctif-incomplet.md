# Banc de mesure — Odoo 17.0 — 2026-09-25 — apres-F17

Mode : **génération** · commit `763d528` · image `odoo@sha256:8779f8157ddcc37b84014c94646073f46fd4ad776b7a5d95fc3b0dc73a24a8fa` · données de la mesure : `C:\Users\ROMARI~1\AppData\Local\Temp\banc_data_eedtmveb`
...
| I4 — Verdict exploitable | 26.7 % | 15 cas générés | ≥ 75 % |
| I5 — Blocage bien attribué | non mesuré | 0 / 0 paires (panne, cas) | 100 % |
| I6 — Coût par nouveau cas | 0.118 $ | 15 nouveaux cas | < 1 € par cas |
...
| generation | crm_opportunite | retest | success | indetermine |  |  |
...
| generation | vente_comptage | retest | technical_error | indetermine |  |  |
| generation | vente_etat_confirme | passed | success | conforme |  |  |
