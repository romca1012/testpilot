  ...
  <div>
    <div class="flex items-center gap-3 flex-wrap">
      ...
      <div class="flex items-center gap-1.5 ml-auto text-muted-foreground">
        ...
        <button v-if="canEdit && canAutomate" class="rounded-md border border-border px-3 py-1.5 text-sm flex items-center gap-1.5 hover:border-primary/40 text-primary disabled:opacity-60"
